...
namespace Toolit.Views.Popups
{
    ...
    public partial class CraftsmanTaskCompletedPopup : PopupPage, CraftsmanTaskCompletedPopupViewModel.ICallback
    {
        public CraftsmanTaskCompletedPopup()
        {
            BindingContext = new CraftsmanTaskCompletedPopupViewModel(this);
            InitializeComponent();
        }
